...
def plot_seq():
    ...
    subprocess.call("plotcon -sequences protein_alignment_" + query_name + ".msf -winsize 4 -graph png -goutfile plotcon", shell =True) ### TRY TO FIND OUT HOW TO CHANGE THE OUTPUT NAME FOR THE PLOTCON 
